...
A [fulgurite](https://github.com/fulgurite-plugin) theme: [Gruvbox](https://github.com/morhetz/gruvbox) light, medium contrast (bg1 · bg0_s · bg0; headings green like markdownH1).
...
Colors after morhetz/gruvbox, MIT.
